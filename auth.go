...
func QrLogin() (d *Driver, err error) {
...
func Generate() (res QrCodeRes, err error) {
	...
	err = qrcode.WriteFile(res.Content.Data.CodeContent, qrcode.Low, 500, filePath)
	openQrCode(filePath)
	return
}
...
func QrCodeQuery(ck string, t int) (res QrCodeStateRes, err error) {
	//urlStr := "https://passport.aliyundrive.com/newlogin/qrcode/query.do?appName=aliyun_drive&fromSite=52&_bx-v=2.2.3"
